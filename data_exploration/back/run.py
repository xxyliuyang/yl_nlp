...
from data_exploration.back.data_load import get_data
from data_exploration.back.bert_model import Classifier
import random
...
def main(args):
    ...
    # 2.加载模型
    classifier = Classifier(label_list=label_list, device=device, model_path=args.model_path)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--task', default="stsa", choices=['stsa', 'snips', 'trec'])
    parser.add_argument('--data_dir', type=str, default="data_exploration/data/SST-2", help="Data dir path with {train, dev, test}.tsv")
    ...
    parser.add_argument('--model_path', default="resources/roberta-base/", type=str)
